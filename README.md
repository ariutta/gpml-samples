...
```
for gpmlfile in $(ls -1 2019/*.gpml); do wpid=$(echo $gpmlfile | awk -F_ '{print $(NF-1)}'); echo "$gpmlfile"; mv $gpmlfile ./gpml/$wpid.gpml; git add gpml/; git commit -am "Add/update $wpid"; git push; sleep 10; done
```
